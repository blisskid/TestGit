...
(function(c) {
    var f = {
            ...
            _create: function(a, b) {
                ...
                a.getDay();
                a.getDate();
                var e = (new Date(d, c, 1)).getDay() - 1;
                (new Date(d, c + 1, 0)).getDate();
        ...
        h = function(a, b) {
            ...
            var e = !1;
            (this.setting.options.showAlways ? (e || (d._init(), e = !0), d.show(), this._isShow = !1) : (d.target.bind("focus",
                function() {
                    e || (d._init(), e = !0);
                    d.show()
    ...
    h.prototype = {
        ...
        _initTpl: function() {
            ...
            this.reference && (g._tempEnd = !1, e.bind("mousemove",
                function(a) {
                    (g.isIn(g._content[0], a.target) ? g._checkHoverColor(a.target) : g._tempEnd && (g._tempEnd = !1, g.update()))
                }))
        },
        setMinDate: function(a) {
            a = (a || "#").toDate();
            var b = !1;
            (a ? b = f.parseDateInt(a) : (this.setting.options.minDate = m, b = l));
            this._min = b
        },
        isIn: function(a, b) {
        ...
        _updateOptions: function() {
            ...
            for (d in a) switch (d) {
                ...
                case "minDate":
                    ...
                    (n = a.minDate) && n != b.minDate && (b.minDate = n, this.setMinDate(n));
                    break;
                case "maxDate":
                    a.maxDate = a.maxDate.toDate();
                    (n = f.parseDateInt(a.maxDate)) && n != this._max && (b.maxDate = a.maxDate, this._max = n);
                    break;
                case "showWeek":
        ...
        _parseDrawMonth: function() {
            var a = !1,
                b = this.setting.options;
            (this.currentDate ? this._drawDate = this.currentDate : ((b.defaultDate ? a = b.defaultDate.toDate() : this._min && (a = b.minDate)), a || (a = m), this._drawDate = a))
        },
        ...
        update: function() {
            ...
            if (a > b)
                for (; b < a; b++) d += this._create(f.addMonth(this._drawDate, b), "other");
        ...
        setWeek: function(a) {
            var b = null,
                b = (a ? c(a) : this.target);
            ((a = b.value().toDate()) ? (a = this.getWhatDay(a)) && 105 <= b.offset().width && b.css({
                "background-image": "url(http://www.caringyou.com.cn/wp-content/plugins/xuanqi_manage/images/" + a + ".png)",
